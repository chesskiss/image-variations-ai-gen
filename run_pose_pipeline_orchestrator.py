...
def main() -> None:
    ...
    pipeline_orchestrator_result = pose_pipeline_orchestrator.run_generation_extraction_and_judge_pipeline(
    ...
    print(f"Selected frame sequence numbers: {pipeline_orchestrator_result.selected_frame_sequence_numbers}")
    print(f"Judge result output directory: {pipeline_orchestrator_result.judge_result_output_directory}")
    print(
